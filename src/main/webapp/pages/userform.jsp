...
<div class="page-header">
    ...
    <span class="label label-info"><a href="?lang=en">en</a></span> | <span class="label label-warning"><a
        href="?lang=jp">jp</a></span>
</div>
...
<div id="tab-content" style="width:400px;">
    ...
    <br/>
    <br/>
    <input type="number" id="age" class="form-control" placeholder="Age"></input><span id="age-err-msg"
