    ...
    s.module("ngAnimate", ["ng"]).config(["$provide", "$animateProvider", function (N, D) {
            ...
            function n(a, d, b, c, h, g, m) {
                ...
                if (J(b, c) || 0 === h.length)g(), u(); else {
                    ...
                    0 === v.length ? (g(), t()) : (r.running && (G.cancel(r.closeAnimationTimeout),
                        q(b), K(r.animations), (r.done || z)(!0)), "addClass" == a && b.hasClass(d) || "removeClass" == a && !b.hasClass(d) ? (g(), t()) : (b.addClass(E), b.data(f, {
                        running: !0,
                        structural: !n,
                        animations: v,
                        done: p
        ...
        D.register("", ["$window", "$sniffer", "$timeout", function (f, g, F) {
            ...
            function L(a, b, w) {
                ...
                var x = a.data(v);
                if (a.hasClass(b) && x) {
                    var M = a[0], l = x.timings, k = x.stagger, n = x.maxDuration, m = x.activeClassName, p = 1E3 * Math.max(l.transitionDelay, l.animationDelay), t = Date.now(), s = P + " " + O, r, x = x.ii, u, y = "";
                    if (0 < l.transitionDuration) {
                        M.style[h + S] = "";
                        var q = l.transitionPropertyStyle;
                        -1 == q.indexOf("all") && (u = !0, y += c + "transition-property: " +
            ...
            var D = "Duration", S = "Property", u = "Delay", r = "IterationCount", W = "$$ngAnimateKey",
                v = "$$ngAnimateCSS3Data", U = "ng-animate-start", N = "ng-animate-active", C = {}, V = 0, Q = [], R;
            return {
